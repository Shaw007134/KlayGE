...
namespace KlayGE
{
	...
	private:
		...
		struct D3DShaderObjectTemplate : public NullShaderObjectTemplate
		{
			std::array<std::shared_ptr<D3DShaderStageObject>, ST_NumShaderTypes> shader_stages_;
		};
